  ...
  return (
    <Select.SelectProvider>
      <Select.Select
        ...
        className="mt-text-sm flex h-auto w-full items-center gap-2 rounded-lg p-2 text-sm transition-all duration-200 ease-in-out hover:bg-gray-200 dark:hover:bg-[#2a3a4a]"
      >
