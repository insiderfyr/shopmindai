...
const Theme = ({ theme, onChange }: { theme: string; onChange: (value: string) => void }) => {
  ...
  return (
    <button
      className="flex items-center gap-2 rounded-lg bg-transparent p-2 text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 dark:bg-[#182533] dark:text-white"
      aria-label={label}
